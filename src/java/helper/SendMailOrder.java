    ...
    public static void sendMailOrder(String receiver, String subject, int orderId, String customerName, String city, String district, String detailAddress, String paymentMethod, List<Cart> CartDetailList, double totalPrice, boolean showPaymentReminder) {
        ...
        try {
            ...
            htmlContent.append("<div style='font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;'>")
                       ...
                       .append("<a href='http://localhost:9998/SWP391_G3_PetShop/myorders' style='display: inline-block; background-color: #FF6600; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-size: 16px;'>Xem đơn hàng</a>")
                       .append("<a href='http://localhost:9998/SWP391_G3_PetShop/home' style='display: inline-block; margin-left: 10px; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-size: 16px; color: #FF6600; border: 1px solid #FF6600;'>Đến cửa hàng của PawPaw</a>")
                       .append("</div>")
