        ...
        <div class="form-block">
            ...
            <form action="changepassword" method="post">
                <div class="form-group first mb-1 position-relative">
                    ...
                    <input type="password" name="oldpassword" id="login-password6" class="form-control" required="">
                ...
                <div class="form-group last mb-1 position-relative">
                    ...
                    <input type="password" name="newpassword" id="login-password7" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters"  class="form-control" required="">
                ...
                <div class="form-group last mb-3 position-relative">
                    ...
                    <input type="password" name="cfnewpassword" id="login-password8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters" class="form-control" required="">
