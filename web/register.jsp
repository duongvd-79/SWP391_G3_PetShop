        ...
        <div class="form-block">
            ...
            <form action="register" method="post">
                ...
                <div class="form-group last mb-3">
                    ...
                    <input value="${address.getDetail()}" type="text" pattern="^\s*\S+\s*$" title="Can not empty" class="form-control" id="address" name="address" required placeholder="Your address">
                </div>
